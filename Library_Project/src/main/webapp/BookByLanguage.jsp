...
<title>Library | BOOKS BY LANGUAGE</title>
...
<body>
	...
	<div class="container-fluid p-0 m-0">
		...
		<h2 class="text-uppercase text-center">
			Books in
			<%=request.getParameter("language")%></h2>
		...
		<div class="row">
			<div class="col-12">
				...
				c.add(Restrictions.eqOrIsNull("language", language));
				%>
							...
							<tr>
								...
								<td>
									<div class="container text-center ">
										<form action="DeleteBook?book_id=<%=b.getBookID()%>"
											method="post">
											<button type="submit" class="btn btn-danger p-1 m-1">Delete</button>
										</form>
								</td>
								<td>
									<form action="BorrowBook?book_id=<%=b.getBookID()%>"
										method="post">
