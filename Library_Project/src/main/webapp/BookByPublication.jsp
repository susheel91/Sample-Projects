...
<title>Library | BOOKS BY PUBLICATION</title>
...
<div class="container-fluid p-0 m-0">
		...
		<br>
		<h2 class="text-uppercase text-center">Books from <%=request.getParameter("publication") %></h2>
		...
		c.add(Restrictions.eqOrIsNull("publication", publication));
